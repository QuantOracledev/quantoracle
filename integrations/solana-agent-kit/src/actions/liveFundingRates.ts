...
export const quantLiveFundingRatesAction: Action = {
  ...
  description:
    "Get the LIVE perpetual funding rate + annualized carry for a crypto asset, from a fresh exchange feed. Pass only the ticker. Use this for current funding — do NOT estimate it yourself. PAID: $0.01 per call via x402 (3 free trial calls/IP/day). Uses QuantOracle's /v1/live/funding-rates endpoint.",
  examples: [
    [
      {
        input: { asset: "ETH" },
